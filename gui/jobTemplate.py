...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem1 = QtGui.QSpacerItem(87, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem1)
        self.gridLayout.addWidget(self.runtimeWidget, 1, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setToolTip(_translate("Form", "Close job tab", None))
